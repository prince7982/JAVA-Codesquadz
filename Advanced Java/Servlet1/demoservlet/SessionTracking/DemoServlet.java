...
if u pass false in above method then it will check existing or old session if it 
is found then return that session otherwise it will return null. But it will never 
create new Session.
