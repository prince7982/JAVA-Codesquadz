/*6. Write a program that prompts the user to input an integer and
   then outputs the number with the digits reversed.
   For Example.if the input is 12345, then output should be 54321.*/
...
class ReversedInput
{
	public static void main(String... s)
	{
		...
		while(true)
		{
			...
			System.out.println("Your Reversed value is = "+rev);
			rev=0;
